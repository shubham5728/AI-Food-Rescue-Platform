      ...
      <section className="hero-glow relative overflow-hidden border-b border-border">
        ...
        <div className="container relative py-12 sm:py-20">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            {/* Orbital Visual Animation */}
            <div className="relative hidden lg:flex items-center justify-center w-full h-[360px]">
              ...
              <div className="absolute w-[300px] h-[300px] rounded-full border border-dashed border-border animate-[spin_30s_linear_infinite_reverse]">
              ...
              <div className="absolute w-[400px] h-[400px] rounded-full border border-dashed border-border/70 animate-[spin_40s_linear_infinite]">
