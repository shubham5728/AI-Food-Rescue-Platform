          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative hidden lg:flex items-center justify-center w-full h-[400px]">
              ...
              <div className="absolute w-[200px] h-[200px] rounded-full border border-dashed border-border animate-[spin_20s_linear_infinite]">
                <div style={{ left: '68px', top: '-32px' }} className="absolute w-16 h-16 bg-card border-2 border-background rounded-full overflow-hidden shadow-md animate-[spin_20s_linear_infinite_reverse] hover:shadow-[0_0_30px_rgba(var(--primary),0.8)] hover:scale-110 transition-all duration-300 cursor-pointer">
              ...
              <div className="absolute w-[320px] h-[320px] rounded-full border border-dashed border-border animate-[spin_30s_linear_infinite_reverse]">
                <div style={{ left: '288px', top: '128px' }} className="absolute w-16 h-16 bg-card border-2 border-background rounded-full overflow-hidden shadow-md animate-[spin_30s_linear_infinite] hover:shadow-[0_0_30px_rgba(var(--primary),0.8)] hover:scale-110 transition-all duration-300 cursor-pointer">
                  <img src="/orbit-food-2.png" alt="Fresh vegetables" className="w-full h-full object-cover" />
                </div>
                <div style={{ left: '-32px', top: '128px' }} className="absolute w-16 h-16 bg-card border-2 border-background rounded-full overflow-hidden shadow-md animate-[spin_30s_linear_infinite] hover:shadow-[0_0_30px_rgba(var(--primary),0.8)] hover:scale-110 transition-all duration-300 cursor-pointer">
              ...
              <div className="absolute w-[440px] h-[440px] rounded-full border border-dashed border-border/70 animate-[spin_40s_linear_infinite]">
                <div style={{ left: '408px', top: '188px' }} className="absolute w-16 h-16 bg-card border-2 border-background rounded-full overflow-hidden shadow-md animate-[spin_40s_linear_infinite_reverse] hover:shadow-[0_0_30px_rgba(var(--primary),0.8)] hover:scale-110 transition-all duration-300 cursor-pointer">
                  <img src="/orbit-food-5.png" alt="Hot catering meal" className="w-full h-full object-cover" />
                </div>
                <div style={{ left: '256px', top: '397px' }} className="absolute w-16 h-16 bg-card border-2 border-background rounded-full overflow-hidden shadow-md animate-[spin_40s_linear_infinite_reverse] hover:shadow-[0_0_30px_rgba(var(--primary),0.8)] hover:scale-110 transition-all duration-300 cursor-pointer">
                  <img src="/orbit-food-3.png" alt="Artisanal bread" className="w-full h-full object-cover" />
                </div>
                <div style={{ left: '10px', top: '317px' }} className="absolute w-16 h-16 bg-card border-2 border-background rounded-full overflow-hidden shadow-md animate-[spin_40s_linear_infinite_reverse] hover:shadow-[0_0_30px_rgba(var(--primary),0.8)] hover:scale-110 transition-all duration-300 cursor-pointer">
                  <img src="/orbit-food-6.png" alt="Fresh fruits" className="w-full h-full object-cover" />
                </div>
                <div style={{ left: '10px', top: '59px' }} className="absolute w-16 h-16 bg-card border-2 border-background rounded-full overflow-hidden shadow-md animate-[spin_40s_linear_infinite_reverse] hover:shadow-[0_0_30px_rgba(var(--primary),0.8)] hover:scale-110 transition-all duration-300 cursor-pointer">
                  <img src="/orbit-food-7.png" alt="Bakery pastries" className="w-full h-full object-cover" />
                </div>
                <div style={{ left: '256px', top: '-21px' }} className="absolute w-16 h-16 bg-card border-2 border-background rounded-full overflow-hidden shadow-md animate-[spin_40s_linear_infinite_reverse] hover:shadow-[0_0_30px_rgba(var(--primary),0.8)] hover:scale-110 transition-all duration-300 cursor-pointer">
